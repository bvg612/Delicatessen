<?php
	...
	Description: This plugin enables you to run your blog in a different language than the backend of your blog. So you can serve your blog using e.g. German as the default language for the users, but keep English as the language for the administration. [](http://coderisk.com/wp/plugin/kau-boys-backend-localization/RIPS-r9Bk1SFAEW)
	Version: 2.1.7
